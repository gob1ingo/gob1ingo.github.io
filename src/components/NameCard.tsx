    ...
    return (
        <div className="card">
            ...
            <p className="bio">
                ...
                Ever since I "borrowed" my older sister's DS, ever since I got to mess around with the Windows XP machines at my summer camp, I've been fascinated by computers. They've always been my interest. <br/>
                <br/>
